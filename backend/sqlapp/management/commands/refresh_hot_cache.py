...
DEFAULT_QUESTIONS = [
    ...
    "What are beginner-friendly golf courses near San Jose?",
    "How are the current conditions at San Jose Municipal Golf Course?",
    "What San Jose golf courses have driving ranges with instructors?",
    "Which San Jose courses offer the best value for money?",
